                        ...
                        <div class="current-events-w">
                          ...
                          <div class="single-event">
                            <div class="event-details">
                               ...
                               */
                              ?>
                              <div class="event-info" style="width:100%; float:none; padding:0;">
                                <div class="event-title">
                                  <h5><?php the_title(); ?></h5>
                                  <div class="register"><a href="<?php echo get_post_meta( get_the_ID(), 'register_link', true ); ?>" class="button">Register</a></div>
                                </div> 
                                <?php 
