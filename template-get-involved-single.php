...
/**
 *
 *  template name: Get Involved - Single
 *
 * 
 */
          ...
          <div class="page-block-i"> 
            ...
            <div class="page-contents" id="page-contents">
             <div class="page-contents-i">
               <div class="row">
                <header class="page-title" style="background-image:url('<?php echo $parent_background_image; ?>')">
                  <div class="page-title-w">
                    <h1><?php echo get_the_title( $post_parent_ID ); ?></h1>
                  </div>  
                </header>
              </div>
                     ...
                     <div class="child-page-block-i">
                       ...
                       <div class="sidebar">
                        <?php 
                          ...
                          get_template_part('sidebars/sidebar','about');
